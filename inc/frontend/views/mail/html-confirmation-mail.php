...
@media only screen and (max-width: 596px) {
   ...
   * @var     string      $time                   Time of the Event
   * @var     string      $food_preferences
   * @var     string      $courses
   * @var     string      $verifyLink              URL to verify the email address
   * @var     Team        $team                    All Data of the team
   *
   */
  ?>
  <body>
                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <p class="text-center">Here are all the informations you send us. Should something change, please let us know under kitchenrun@iswi.org</p>
                                </th>
                                <th class="expander"></th>
                              </tr>
                            </table>
                                    ...
                                    <tr>
                                      <th class="callout-inner secondary large-12">
                                        ...
                                        <table class="desc">
                                          ...
                                          <tr>
                                              <td>Member 1:</td><td><?= $team->getMember1() ?></td>
                                          </tr>
                                          
                                          <tr>
                                              <td>Member 2:</td><td><?= $team->getMember2() ?></td>
                                          </tr>
                                          ...
                                          <tr>
                                              <td>E-Mail:</td><td><?= $team->getEmail() ?></td>
                                          </tr>
                                          
                                          <tr>
                                              <td>Phone:</td><td><?= $team->getPhone() ?></td>
                                          </tr>
                                          
                                          <tr>
                                              <td>Food Preferences:</td><td><?= $food_preferences ?></td>
                                          </tr>
                                          
                                          <tr>
                                              <td>Courses:</td><td><?= $courses ?></td>
                                          </tr>
                        ...
                        <tr>
                          <th class="small-12 large-12 columns first last">
                            <table>
                              <tr>
                                <th>
                                  <p class="text-center">Please verify your E-Mail Address by clicking on the button down below!</p>
                                
                                  <center data-parsed>
                                    <table class="button float-center success">
                                      <tr>
                                        <td>
                                          <table>
                                            <tr>
                                              <td><a href="<?= $verifyLink ?>">verify E-Mail Address</a></td>
                                            </tr>
                                          </table>
                                        </td>
                                      </tr>
